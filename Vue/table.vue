...
export default {
    ...
    computed: {
        ...
        workingDayValidate: {
            get() {
                ...
                console.log("workingDayValidate",[...new Set(workingDay)].map(day => Math.round(+day)).filter(day => day < 7 && day > -1);)
    ...
    methods: {
        ...
        getDateInfo(monthDiff = 0) {
            ...
            console.log("getDateInfo", this.selectedYear, +this.selectedMonth + monthDiff, date)
            return {
        ...
        calculateTableData() {
            ...
            console.log("this.tableArr calculateOnDutyGroup", this.tableArr)
        ...
        calculateOnDutyGroup(tableArr) {
            ...
            console.log("calculateOnDutyGroup tableArr", tableArr)
            return tableArr;
        },
